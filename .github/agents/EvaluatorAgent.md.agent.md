...
## Purpose
Evaluate student code in `Given pdf` against the official questions in `Test_Questions.docx` and the rubric JSON files for each test. Produce a structured evaluation with per-question scoring and feedback.

## Scope
- Tests: Test_1, Test_2, Test_3, Test_2_makeup
- Code source: `Ask user for the code Source and show the options from _code_json`
